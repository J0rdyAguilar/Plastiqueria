  ...
  return (
    <div className="page">
      ...
      <div className="row" style={{ justifyContent: "space-between", alignItems: "flex-end" }}>
        ...
        <div className="topbar-actions" style={{ display: "flex", gap: 10, alignItems: "flex-end" }}>
          ...
          <div className="split-forms">
            ...
            <form onSubmit={cerrarCaja} className="form-card">
              <div className="row" style={{ justifyContent: "space-between" }}>
                <b>Cerrar caja</b>
                {!isAbierta ? (
                  <span className="badge off">Sin caja</span>
                ) : (
      ...
      <div className="card pad" style={{ marginTop: 14 }}>
        <div className="row" style={{ justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div className="muted small">{loading ? "Cargando…" : `${historial.length} registro(s)`}</div>
        </div>
                ...
                historial.map((c) => {
                  ...
                  return (
                    <tr key={c.id}>
                      ...
                      <td>
                        <span className="pill">{money(c.efectivo_inicial)}</span>
                      </td>
                      <td>
                        {c.efectivo_final != null ? (
                          <span className="pill">{money(c.efectivo_final)}</span>
                        ) : (
                          "—"
                        )}
                      </td>
